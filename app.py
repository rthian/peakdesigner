...
TOMO_QUESTIONS = [
    ...
    ("I continue to work in my role because I gain rewards or avoid financial punishment. (Economic Pressure)", "economic"),
        ...
        if st.button("Compute Overall Averages"):
            if user_name in data:
                ...
                for assess in assessments:
                    ...
                    if 'tomo' in assess and assess['assessor'] == "Self":
